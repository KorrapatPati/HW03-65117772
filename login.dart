    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        labelStyle: TextStyle(
          color: _emailFocusNode.hasFocus ? Colors.purple : Colors.grey,
        ),
        prefixIcon: Icon(
          Icons.email,
          color: _emailFocusNode.hasFocus ? Colors.purple : Colors.grey,
  ...
  Widget passwordInputField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        labelText: 'Password',
        labelStyle: TextStyle(
          color: _passwordFocusNode.hasFocus ? Colors.purple : Colors.grey,
        ),
        prefixIcon: Icon(
          Icons.lock,
          color: _passwordFocusNode.hasFocus ? Colors.purple : Colors.grey,
  ...
  Widget loginButton() {
    return ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(
        backgroundColor: Colors.purple, // เปลี่ยนสีปุ่มเป็นสีฟ้า
      ),
      child: const Text(
        'Login',
